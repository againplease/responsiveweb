...
<body>
    ...
    <div class="content">
        <div class="info-box" onclick="window.location.href='curriculum_detail.jsp?type=undergraduate'">
            Undergraduate
        </div>
        <div class="info-box" onclick="window.location.href='curriculum_detail.jsp?type=master'">
            Master
        </div>
        <div class="info-box" onclick="window.location.href='curriculum_detail.jsp?type=phd'">
            Ph.D
        </div>
        <div class="info-box" onclick="window.location.href='curriculum_detail.jsp?type=aiminor'">
            AI Minor
        </div>
    </div>
